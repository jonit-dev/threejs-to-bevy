...
- `tools/verify/artifacts/milestones/v4/v4-scripting-report.json`
- `tools/verify/artifacts/milestones/v4/verification-report.json`
- `tools/verify/artifacts/milestones/v4/web-effects.json`
- `tools/verify/artifacts/milestones/v4/native-effects.json`
- `tools/verify/artifacts/milestones/v4/effects-diff.json`
- `tools/verify/artifacts/milestones/v4/web-effect-log.json`
- `tools/verify/artifacts/milestones/v4/web-visual-report.json`
- `tools/verify/artifacts/milestones/v4/frame-01.png`, `frame-02.png`, and `frame-03.png`
...
`tools/verify/artifacts/milestones/v4` for release-gate aggregation. The fixed trace uses
