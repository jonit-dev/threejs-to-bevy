...
- [PRD-001: Authoring Friction Fixes](../done/PRD-001-authoring-friction-fixes.md):
...
- [PRD-002: Playtest Loop Trust And Visual Proof](../done/other/chess-trial-playtest-loop-trust-and-visual-proof.md):
