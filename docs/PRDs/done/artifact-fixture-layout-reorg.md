...
| Example-specific evidence | `examples/<name>/artifacts/<gate>/*` | Move new output to the owning example's `artifacts/<gate>/`; verifier reports may link to those paths. |
