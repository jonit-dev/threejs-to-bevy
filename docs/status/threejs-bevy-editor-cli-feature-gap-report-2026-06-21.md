...
- ✅ 2026-06-24: WebP texture assets are now accepted by the SDK, IR schema,
  compiler inference, environment preview/dependency emission, target profile
  validation, web texture loading, and Bevy texture loading paths. A
  source-authored stylized nature component slice now exposes SDK helpers and
