...
The authoring diagnostic contract now carries optional structured `fix`
payloads for the highest-friction agent repair paths. Registered prescriptive
codes include machine-readable repair instructions, snippets, allowlists,
cookbook IDs, and docs links, and MCP wrappers preserve those payloads
unchanged from CLI/core JSON results.
