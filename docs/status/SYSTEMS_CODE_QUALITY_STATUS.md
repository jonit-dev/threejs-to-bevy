...
| 🟡 | CLI command surface | `tn` command metadata, dispatch, help, docs expectations, and implementation routing remain hand-maintained, but command metadata uniqueness, help coverage, and dispatch alignment now have integrity tests. | Execute PRD-003 incremental typed command registry and shared argv plumbing. | `docs/PRDs/done/other/adapter-surface-remediation-2026-07-08/PRD-002-adapter-surface-drift-gates.md`; `docs/PRDs/other/adapter-surface-remediation-2026-07-08/PRD-003-cli-command-registry-and-shared-arg-plumbing.md`; `packages/cli/src/index.test.ts`; `pnpm --filter @threenative/cli test` |
