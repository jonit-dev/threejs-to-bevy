...
| Game production | Active | Generated games target polished vertical slices with plan, scaffold-first follow-up, QA, release, and playtest evidence. | [game production](status/capabilities/game-production.md) |
