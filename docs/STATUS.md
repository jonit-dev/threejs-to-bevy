...
| Physics | Active | Phases 1-2 promote compound colliders, at-point forces, retained queries, and wheel/tire/surface simulation; Phases 3-4 implement pre-release drivetrain and aerodynamics with paired web/native, real web/desktop playtests, and manual evidence, while release enrollment and later phases remain active. | [physics](status/capabilities/physics.md) |
