...
| Rendering | Active | Authored rendering IR maps to web and native through adapter-private implementations, a shared residual contract registry owns advanced geometry/material/renderer/window classifications and diagnostics, parity gates use reusable named visual metric bundles, portable photoreal features have bounded fixture proof, and raw/backend shader surfaces and broader release policy remain deferred. | [rendering](status/capabilities/rendering.md) |
