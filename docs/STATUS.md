...
| Game production | Active | Generated games target polished vertical slices with selectable L1 archetype scaffolds, biome world source/proof, compositional mechanic blocks, declarative Spawner/GameFlow/Sequence source contracts, proof-family plan-apply scenarios, and equal-proof collector token evidence below vanilla. | [game production](status/capabilities/game-production.md) |
