...
| Rendering | Active | Authored rendering IR maps through adapter-private implementations; live reconciliation, texel-stable portable sun-shadow cascades with honest Bevy approximation reporting, calibrated lighting/material/dense evidence, cubemaps, render-layer limits, teardown, residual classification, and deterministic photoreal proof are covered, while raw/backend shader surfaces remain deferred. | [rendering](status/capabilities/rendering.md) |
