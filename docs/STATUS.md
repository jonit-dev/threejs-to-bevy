...
| UI | Active | Retained structured UI is the portable path; web overlay actions and script-driven live state are delivered through portable runtime facades, while overlays remain bounded and separate. | [ui](status/capabilities/ui.md) |
