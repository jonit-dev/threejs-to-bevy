...
| UI | Active | Retained structured UI is the portable path; web overlay actions and script-driven live state are delivered through portable runtime facades, and native/UI parity claims are truth-graded against named proof. | [ui](status/capabilities/ui.md) |
