...
| Rendering | Active | Authored rendering IR maps to web and native through adapter-private implementations; live renderable/component reconciliation, six-face cubemaps, portable render-layer limits, and ownership-aware teardown are covered; a shared residual contract registry owns advanced classifications and diagnostics, while raw/backend shader surfaces remain deferred. | [rendering](status/capabilities/rendering.md) |
