...
| Scripting | Active | Portable TypeScript scripts use convention-first context APIs and supported helper imports. | [scripting](status/capabilities/scripting.md) |
