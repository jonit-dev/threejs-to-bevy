...
| --- | --- | --- | --- |
| Authoring | Active | Structured source, schema-aware CLI/MCP/client operations, transactional/idempotent adoption-aware recipes, descriptor-derived concrete game plans, compact project maps, bounded actor archetypes, project type generation, cookbook, multi-scenario iterate, playtest schema/scaffold/setup, starter API cards, prescriptive diagnostics with derived resource schemas, semantic proof gates, anti-proof-theater scoring, and an experimental typed game-spec slice are supported. | [authoring](status/capabilities/authoring.md) |
| Scripting | Active | Portable TypeScript scripts use typed/project-generated context APIs, `defineBehavior` metadata, convention-first helper aliases, deterministic project-local script modules, generated stdlib runtime source, derived literal resource access declarations, same-tick composing resource patches, persistent sensor phases, bounded runtime write provenance, actionable transform conflict diagnostics, script audio, bounded particles, delayed commands, retained UI actions, reconciled tag/lifecycle observations, runtime-owned patrol/FSM/countdown primitives, bounded tween/camera-shake/feedback/world-text presentation, runtime observations, and prescriptive diagnostics. | [scripting](status/capabilities/scripting.md) |
...
| Assets | Active | Bundle-local assets, GLB/glTF, generated meshes, heightmaps, deterministic terrain-aware scatter, generated biome world source, materials, audio, catalog sourcing, and web-only model-test view/screenshot/turntable inspection are validated; web captures are not Bevy parity evidence. | [assets](status/capabilities/assets.md) |
