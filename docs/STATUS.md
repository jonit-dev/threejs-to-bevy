...
| Scripting | Active | Portable TypeScript scripts use typed context APIs, convention-first helpers, supported helper imports, and prescriptive compiler diagnostics. | [scripting](status/capabilities/scripting.md) |
