...
| Assets | Active | Bundle-local assets, GLB/glTF, generated meshes, heightmaps, deterministic terrain-aware scatter, materials, audio, and catalog sourcing are validated. | [assets](status/capabilities/assets.md) |
