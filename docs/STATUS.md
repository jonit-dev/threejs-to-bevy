...
| UI | Active | Retained structured UI is the portable path; TSX authoring has typed text input/component wrappers, web overlay actions, live state, safe-area/context-menu/focus semantics are proved in bounded gates, and native/UI parity claims are truth-graded against named proof. | [ui](status/capabilities/ui.md) |
