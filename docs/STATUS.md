...
| Tooling/proof | Active | Verification tools own docs checks, boundary fixture audits, agent IO/session-cost/retry-chain/churn budgets, runtime resource/state-stagnation diagnostics, secondary axis-delta playtest proof, web performance-proof emission/validation, desktop performance-proof unsupported diagnostics, smoke/release gates, proof manifests, aggregate artifacts, and equal-proof benchmark token reporting. | [tooling/proof](status/capabilities/tooling-proof.md) |
