...
| Physics | Active | Portable physics and character-control contracts exist for authored components, compiler-emitted heightfield descriptors, web terrain collision, and playtest-proved behavior. | [physics](status/capabilities/physics.md) |
