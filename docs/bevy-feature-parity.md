...
- [ ] `P1` Portable procedural mesh authoring
  - [ ] MeshBuilder API for generated static meshes
  - [ ] Primitive composition helpers for organic props
  - [ ] Compiler-only Three.js BufferGeometry import/snapshot
