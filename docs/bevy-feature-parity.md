...
| ⚠️ | Lights and shadows | Portable cascaded sun shadows now share authored distance/split/blend/stabilization intent and requested/applied reports. Web applies texel-stable adapter-owned cascades; Bevy maps through its native builder and explicitly reports its exponential intermediate-split approximation where exact uniform/practical layouts are unavailable. Probes/environment maps still have bounded semantics, while spherical/area and baked/mixed lighting remain diagnostic boundaries. | Ambient/directional/point/spot lights, stable cascaded shadows, probes, environment maps, and bounded quality profiles. | `pnpm verify:focused verify:shadow-cascade-stability`, `pnpm verify:focused verify:feature-parity-visual-polish` |
