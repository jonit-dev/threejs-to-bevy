...
- [ ] `P2` Light probes and environment maps
  - [x] V9-04 Phase 1 SDK/IR/compiler contract and conformance fixture for
...
- [ ] `P1` Skyboxes and cubemap/compressed texture handling
  - [x] V9-04 Phase 1 validates bundle-local cubemap/equirect texture refs and
    emits rendering capabilities; runtime visual mapping is still open
