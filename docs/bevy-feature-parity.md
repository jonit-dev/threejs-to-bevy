...
- [x] `P1` Skyboxes and cubemap/equirect texture handling
  - [x] V9-04 validates bundle-local cubemap/equirect texture refs, emits
    rendering capabilities, and reports web/native skybox observations;
    compressed texture and screenshot-level visual parity remain deferred
