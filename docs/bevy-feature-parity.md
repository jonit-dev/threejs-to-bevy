...
| Audio | ⚠️ | Local OGG/WAV validation, web HTML-audio sink, Bevy autoplay loop spawning, portable volume, and deterministic audio command observations. | Stop, spatial audio, buses/mixer routing, listener/emitters, and richer UI/audio services are deferred. |
