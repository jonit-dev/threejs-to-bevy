...
const cases = [
  ...
  { project: "examples/advanced-vehicle-course", scenario: "advanced-vehicle-course-no-throttle", maxMovementDelta: 25, expected: { "resource.CourseState.damage": 0, "resource.CourseState.events": ["retry"], "resource.CourseState.jumped": false, "resource.CourseState.retryCount": 1 }, negativeControl: true, requiredAssertions: ["movement", "resource.CourseState.damage", "resource.CourseState.events", "resource.CourseState.jumped", "resource.CourseState.retryCount"] },
