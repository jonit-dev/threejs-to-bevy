...
const cases = [
  { project: "examples/advanced-vehicle-course", scenario: "advanced-vehicle-course-objective", maxMovementDelta: 20, expected: { "resource.CourseState.checkpoint": 3, "resource.CourseState.collisionEntity": "damage-barrier", "resource.CourseState.damage": 25, "resource.CourseState.events": ["retry", "mixed-surface", "jump", "collision-damage", "finish"], "resource.CourseState.jumped": true, "resource.CourseState.mixedSurface": true, "resource.CourseState.objectiveStep": 4, "resource.CourseState.retryCount": 1, "resource.CourseState.status": "finished" }, requiredAssertions: ["movement", "resource.CourseState.checkpoint", "resource.CourseState.collisionEntity", "resource.CourseState.damage", "resource.CourseState.events", "resource.CourseState.jumped", "resource.CourseState.mixedSurface", "resource.CourseState.objectiveStep", "resource.CourseState.retryCount", "resource.CourseState.status"] },
  { project: "examples/advanced-vehicle-course", scenario: "advanced-vehicle-course-no-throttle", maxMovementDelta: 25, expected: { "resource.CourseState.damage": 0, "resource.CourseState.jumped": false, "resource.CourseState.objectiveStep": 0, "resource.CourseState.retryCount": 1 }, negativeControl: true, requiredAssertions: ["movement", "resource.CourseState.damage", "resource.CourseState.jumped", "resource.CourseState.objectiveStep", "resource.CourseState.retryCount"] },
  { project: "examples/aerodynamics-flight-course", scenario: "aerodynamics-flight-course-objective", maxMovementDelta: 30, expected: { "resource.FlightState.events": ["retry", "takeoff", "gust", "stall", "recovery", "landing"], "resource.FlightState.gust": true, "resource.FlightState.takeoff": true, "resource.FlightState.stall": true, "resource.FlightState.recovered": true, "resource.FlightState.landed": true, "resource.FlightState.objectiveStep": 5, "resource.FlightState.retryCount": 1 }, requiredAssertions: ["movement", "resource.FlightState.events", "resource.FlightState.gust", "resource.FlightState.takeoff", "resource.FlightState.stall", "resource.FlightState.recovered", "resource.FlightState.landed", "resource.FlightState.objectiveStep", "resource.FlightState.retryCount"] },
  { project: "examples/destruction-range", scenario: "destruction-range-projectile-threshold", maxMovementDelta: 4, expected: { "resource.DestructionState.activePieceBudget": 4, "resource.DestructionState.events": ["impact", "regional-break", "settled"], "resource.DestructionState.impact": true, "resource.DestructionState.objectiveStep": 3, "resource.DestructionState.regionalBreak": true, "resource.DestructionState.settled": true }, requiredAssertions: ["movement", "resource.DestructionState.activePieceBudget", "resource.DestructionState.events", "resource.DestructionState.impact", "resource.DestructionState.objectiveStep", "resource.DestructionState.regionalBreak", "resource.DestructionState.settled"] },
  { project: "examples/destruction-range", scenario: "destruction-range-retry", maxMovementDelta: 0, expected: { "resource.DestructionState.events": ["retry"], "resource.DestructionState.objectiveStep": 0, "resource.DestructionState.retryCount": 1 }, requiredAssertions: ["resource.DestructionState.events", "resource.DestructionState.objectiveStep", "resource.DestructionState.retryCount"] },
] as const;
