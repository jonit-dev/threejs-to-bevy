...
const EDITOR_OPERATION_GAPS = gapMap([
  ...
  "distribution.set_app", "distribution.set_target", "generator.record_blender",
  ...
  "schema.set", "scene.add_prefab_instance", "scene.add_prefab_instances", "scene.remove_entity", "scene.remove_resource", "scene.remove_ui_node",
...
const EDITOR_SMOKE_GAPS = gapMap([
  ...
  "sequence.add_key", "schema.create", "schema.set", "target.set_profile", "scene.add_prefab_instance", "scene.add_prefab_instances", "scene.remove_entity", "scene.remove_resource", "scene.remove_ui_node", "scene.layout_ten_pin", "scene.add_group",
