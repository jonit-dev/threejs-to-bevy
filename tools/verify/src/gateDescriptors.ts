...
export const GATE_DESCRIPTOR_MIGRATION_GAPS: readonly GateDescriptorMigrationGap[] = [
  ...
  { category: "focused-inline", name: "verify:feature-parity-ui-native", owner: "tools/verify feature-parity UI native gate", reason: "UI-native proof composes registry-derived browser/native captures, observed regions, live widget behavior, and platform-scoped accessibility metadata.", reviewed: "2026-07-14" },
