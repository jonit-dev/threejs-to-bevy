...
Repo-wide instructions for Claude and other AI coding agents working on
ThreeNative. This file mirrors `AGENTS.md`; keep both files aligned when
changing repo-wide agent guidance.
