...
export { disposePhysicsRuntime, initializePhysicsRuntime, observePhysicsContactImpulses, observePhysicsDestructionBodies, preparePhysicsRuntime, stepPhysics, tracePhysicsJoints, traceRigidBodyPrimitive, type IPhysicsContactImpulseObservation, type IPhysicsDestructionBodyObservation, type IPhysicsEventPayload, type IPhysicsJointObservation, type IRigidBodyTraceInput, type IRigidBodyTraceObservation } from "./physics.js";
