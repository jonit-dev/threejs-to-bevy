...
export { traceAdvancedPhysicsDestruction, type IAdvancedPhysicsDestructionScenarios, type IAdvancedPhysicsDestructionTrace } from "./advancedPhysicsDestruction.js";
export { createPhysicsDestructionRuntime, observePhysicsDestruction, queuePhysicsDestructionDamage, reconcilePhysicsDestructibles, registerPhysicsDestructible, stepPhysicsDestruction, unregisterPhysicsDestructible, type IFractureManifest, type IPhysicsDestructibleComponent, type IPhysicsDestructionCause, type IPhysicsDestructionCleanup, type IPhysicsDestructionDamage, type IPhysicsDestructionEvent, type IPhysicsDestructionRuntime } from "./physicsDestruction.js";
export { createWebDestructionHost, type IWebDestructionHost } from "./webDestructionHost.js";
export { collectPhysicsDebugCore, collectPhysicsDebugSnapshot, PHYSICS_DEBUG_CATEGORIES, PHYSICS_DEBUG_LIMITS, PHYSICS_DEBUG_PRIMITIVE_KINDS, PHYSICS_DEBUG_SCHEMA, PHYSICS_DEBUG_VERSION, renderPhysicsDebugOverlay, type IPhysicsDebugCore, type IPhysicsDebugPrimitive, type IPhysicsDebugSnapshot, type IPhysicsDebugTelemetry, type PhysicsDebugCategory, type PhysicsDebugPrimitiveKind } from "./physicsDebug.js";
...
export { disposePhysicsRuntime, initializePhysicsRuntime, observePhysicsContactImpulses, observePhysicsDestructionBodies, observePhysicsTelemetryStats, preparePhysicsRuntime, stepPhysics, tracePhysicsJoints, traceRigidBodyPrimitive, type IPhysicsContactImpulseObservation, type IPhysicsDestructionBodyObservation, type IPhysicsEventPayload, type IPhysicsJointObservation, type IRigidBodyTraceInput, type IRigidBodyTraceObservation } from "./physics.js";
...
export { applyPhysicsAerodynamicBindings, disposePhysicsAerodynamics, observePhysicsAerodynamics, setPhysicsAerodynamicInputs, stepPhysicsAerodynamics, type IAerodynamicInputs } from "./physicsAerodynamics.js";
