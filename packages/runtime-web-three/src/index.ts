...
export { applyEnvironmentBookmark, createEnvironmentRuntime, observeEnvironmentScene, type IEnvironmentObservation, type IEnvironmentRuntime } from "./environment.js";
