...
| `v6-animation-clips` | `animation:clip-metadata`, `asset:model.glb` | V6 animation clip contract fixture for deterministic model asset clip metadata and V7 animation graph deferrals. |
