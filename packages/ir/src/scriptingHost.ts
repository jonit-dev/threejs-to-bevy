...
export const SCRIPT_HOST_SERVICE_MATRIX = [
  ...
  { bevy: "implemented", context: "ctx.particles.emit", domain: "particles", service: "particles.emit", web: "implemented" },
  { bevy: "implemented", context: "ctx.particles.play", domain: "particles", service: "particles.play", web: "implemented" },
  ...
  { bevy: "implemented", context: "ctx.physics.addForce", domain: "physics", service: "physics.addForce", web: "implemented" },
  { bevy: "implemented", context: "ctx.physics.addTorque", domain: "physics", service: "physics.addTorque", web: "implemented" },
  { bevy: "implemented", context: "ctx.physics.applyAngularImpulse", domain: "physics", service: "physics.applyAngularImpulse", web: "implemented" },
  { bevy: "implemented", context: "ctx.physics.applyImpulse", domain: "physics", service: "physics.applyImpulse", web: "implemented" },
  ...
  { bevy: "implemented", context: "ctx.physics.setAngularVelocity", domain: "physics", service: "physics.setAngularVelocity", web: "implemented" },
  { bevy: "implemented", context: "ctx.physics.setLinearVelocity", domain: "physics", service: "physics.setLinearVelocity", web: "implemented" },
