...
export const SUPPORTED_SCRIPT_HELPER_IMPORTS = ["@threenative/script-stdlib"] as const;
...
export function bundleSystemScripts(systems: ReadonlyArray<ISystemScriptSource>): IScriptBundleResult {
  ...
  const helperDeclarations = helperModules.includes("@threenative/script-stdlib") ? [SCRIPT_STDLIB_BUNDLE_SOURCE] : [];
