...
async function rewriteLocalWorkspaceDependencies(projectPath: string): Promise<void> {
  ...
  packageJson.dependencies = rewriteDependency(packageJson.dependencies, "@threenative/ir", "packages/ir", {
    onlyIfPresent: true,
  });
...
async function rewritePublishedDependencies(projectPath: string): Promise<void> {
  ...
  packageJson.dependencies = rewritePublishedDependency(packageJson.dependencies, "@threenative/ir", {
    onlyIfPresent: true,
  });
