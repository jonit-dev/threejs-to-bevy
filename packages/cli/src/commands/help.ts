...
export const HELP_TOPICS: Record<string, HelpTopic> = {
  ...
  "visual-qa": {
    ...
    commands: ["tn dev --target web", "tn verify [--project <path>] [--frames <count>] [--json]", "tn help screenshot", "tn help record"],
    docs: ["docs/workflows/developer-workflow.md", "docs/workflows/ai-workflows.md"],
    examples: ["Run focused validation/build first, then capture visual proof and report exact artifact paths."],
  ...
  screenshot: {
    commands: ["tn verify --frames 1 --json", "tn compare-images <first.png> <second.png> [--json]"],
    docs: ["docs/workflows/developer-workflow.md", "docs/runtime/README.md"],
    examples: ["Use tn verify for current screenshot proof until a dedicated tn screenshot command is available."],
  ...
  record: {
    commands: ["tn dev --target web", "tn verify --frames <count> --expect-motion --json"],
    docs: ["docs/workflows/developer-workflow.md", "docs/runtime/README.md"],
    examples: ["Use multi-frame tn verify motion evidence until a dedicated tn record command is available."],
