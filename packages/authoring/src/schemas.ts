...
export const blenderRecipeOperationKeys = new Set(["kind", "id", "inputs", "parent", "child", "node", "axis", "threshold", "negative", "positive"]);
export const blenderRecipeAnimationKeys = new Set(["id", "duration", "loop", "tracks"]);
export const blenderRecipeAnimationTrackKeys = new Set(["node", "property", "pivot", "keyframes"]);
...
export const supportedBlenderSourceRecipeOperations = new Set(["decimate", "split-by-axis", "transform"]);
