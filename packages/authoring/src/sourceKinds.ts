...
export const authoringSourceMatrix = [
  ...
  },
  {
    ...
    typescriptRole: "none",
    editorRoundTrip: "required",
    notes: "Scene documents exist, but lifecycle policy is still not a complete structured source surface.",
  },
  {
  ...
  },
  {
    ...
    typescriptRole: "none",
    editorRoundTrip: "required",
    notes: "Scene-local prefab declarations exist; standalone prefab documents and instance override operations are missing.",
  },
  {
  ...
  },
  {
    ...
    typescriptRole: "none",
    editorRoundTrip: "required",
    notes: "Input IR can be emitted, but durable input source documents and operations are missing.",
  },
  {
    id: "ui-document",
    ...
    typescriptRole: "none",
    editorRoundTrip: "required",
    notes: "Scene-local UI nodes and bindings exist; full retained UI document/layout/style/widget coverage is missing.",
  },
  {
    id: "asset-document",
  ...
  },
  {
    ...
    typescriptRole: "none",
    editorRoundTrip: "required",
    notes: "Generated materials IR is not a durable material authoring source.",
  },
  {
    id: "mesh-document",
    categoryId: "meshes",
    ...
    typescriptRole: "none",
    editorRoundTrip: "required",
    notes: "Generated mesh payloads need structured declarations and provenance instead of generated bundle edits.",
  },
  {
    id: "audio-document",
    ...
    typescriptRole: "none",
    editorRoundTrip: "required",
    notes: "Audio IR exists in examples, but durable audio source documents are missing.",
  },
  {
    id: "systems-document",
    ...
    editorRoundTrip: "required",
    notes: "Scene-local script refs exist; complete system metadata documents and effect declarations are missing.",
  },
  {
