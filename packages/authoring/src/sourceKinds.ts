...
export const authoringSourceMatrix = [
  {
    ...
    notes: "Project metadata source documents are classified, validated, and mutable through project.create / tn project init-source for id, source roots, authoring version, and build targets; project-level scene ordering remains open.",
  },
  {
  ...
  },
  {
    ...
    typescriptRole: "none",
    editorRoundTrip: "required",
    notes: "Current scene source covers core ECS mutations plus typed camera projection/frustum, light, mesh-renderer, render-layers, visibility, rigid-body, collider, character-controller component operations, zero-field tag components, and SceneContainer group entities; full visual scene and hierarchy coverage is incomplete.",
  },
  {
    id: "prefab-document",
  ...
  },
  {
    ...
    typescriptRole: "none",
    editorRoundTrip: "required",
    notes: "Scene-local resources plus reusable resources documents and schema documents now have source validation, CLI mutation, and bundle lowering; broader editor schema controls remain later work.",
  },
  {
    id: "input-document",
  ...
  },
  {
    ...
    typescriptRole: "none",
    editorRoundTrip: "required",
    notes: "Asset source documents and CLI operations cover id/type/path, render-target width/height/usage/format declarations, promoted model animation clips, graph states, and bounded particle emitters; import settings and dependency copy policy remain later work.",
  },
  {
  ...
  },
  {
    ...
    typescriptRole: "none",
    editorRoundTrip: "required",
    notes: "Mesh source documents and CLI/registry/editor operations cover primitive and custom attribute/index declarations; generated mesh provenance, import settings, and broader editor controls remain later work.",
  },
  {
    ...
    typescriptRole: "none",
    editorRoundTrip: "required",
    notes: "Environment source documents and create/set-skybox/set-map/set-terrain/set-path/set-walkability/set-light-probe/set-source-asset-lod CLI/editor operations cover promoted visual fields plus path, walkability, light-probe, and source-asset LOD metadata.",
  },
  {
    id: "audio-document",
  ...
  },
  {
    ...
    editorRoundTrip: "required",
    notes: "Standalone system documents and create/attach-script/set-metadata CLI, registry, and editor operations cover schedules, script refs, and promoted query/effect metadata; advanced runtime callbacks remain later work.",
  },
  {
  ...
  },
  {
    ...
    sourceDocuments: ["content/generators/*.generator.json", "src/generators/**/*.ts"],
    structuredSourceSupport: "partial",
    cliOperationSupport: "partial",
    typescriptRole: "generator",
    editorRoundTrip: "one-way-generator-output",
    notes: "Generator provenance documents and generator.record capture module/export, outputs, hashes, and overwrite policy; generated outputs remain one-way and do not receive automatic reverse patches from editor changes.",
  },
  {
