...
export const authoringSourceMatrix = [
  ...
  },
  {
    ...
    typescriptRole: "none",
    editorRoundTrip: "required",
    notes: "Current scene source covers core ECS mutations plus typed camera projection/frustum, light, mesh-renderer, rigid-body, collider, character-controller component operations, zero-field tag components, and SceneContainer group entities; full visual scene and hierarchy coverage is incomplete.",
  },
  {
    id: "prefab-document",
