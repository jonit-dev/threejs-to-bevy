  ...
  if (isRecord(data)) {
    switch (data.schema) {
      ...
      case "threenative.runtime-config":
        return "runtime";
      case "threenative.target-profile":
        return "target";
      case "threenative.resources":
        return "resources";
      case "threenative.schema":
      case "threenative.component-schemas":
      case "threenative.resource-schemas":
        return "schema";
...
export function classifyAuthoringDocumentPath(projectRelativePath: string): AuthoringDocumentKind {
  ...
  if (projectRelativePath.endsWith(".interactions.json")) {
    return "interaction";
  }
  ...
  if (projectRelativePath.endsWith(".schema.json")) {
    return "schema";
  }
  if (projectRelativePath.endsWith(".scene.json")) {
    return "scene";
  ...
  if (projectRelativePath.endsWith(".target.json")) {
    return "target";
  }
