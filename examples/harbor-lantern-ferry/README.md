# Harbor Lantern Ferry

Steer a small ferry through a foggy harbor, collect oil canisters, relight pier
beacons, avoid drifting crates, and return to the home dock before the lantern
timer expires. The example keeps gameplay in `src/scripts/player.ts` and all
durable scene/UI/input/material data under `content/`.
