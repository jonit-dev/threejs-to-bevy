...
const artifactDir = resolve(root, "artifacts/v10/post-antialiasing");
...
const report = {
  artifacts: {
    ...
    nativeTrace: "artifacts/v10/post-antialiasing/native-trace.json",
    webTrace: "artifacts/v10/post-antialiasing/web-trace.json",
  },
  comparisons,
