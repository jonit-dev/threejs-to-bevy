...
const artifactDir = resolve(root, "tools/verify/artifacts/post-antialiasing");
...
const report = {
  artifacts: {
    ...
    nativeTrace: "tools/verify/artifacts/post-antialiasing/native-trace.json",
    webTrace: "tools/verify/artifacts/post-antialiasing/web-trace.json",
  },
  comparisons,
