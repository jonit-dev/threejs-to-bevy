...
const artifactDir = resolve(root, "artifacts/v10/native-instancing");
...
const report = {
  artifacts: {
    ...
    nativeTrace: "artifacts/v10/native-instancing/native-trace.json",
    webTrace: "artifacts/v10/native-instancing/web-trace.json",
  },
  comparisons,
