...
const artifactDir = resolve(root, "artifacts/v10/editor-tools");
...
const report = {
  artifacts: {
    ...
    nativeTrace: "artifacts/v10/editor-tools/native-trace.json",
    webTrace: "artifacts/v10/editor-tools/web-trace.json",
  },
  comparisons,
