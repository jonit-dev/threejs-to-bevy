...
const artifactDir = resolve(root, "tools/verify/artifacts/editor-tools");
...
const report = {
  artifacts: {
    ...
    nativeTrace: "tools/verify/artifacts/editor-tools/native-trace.json",
    webTrace: "tools/verify/artifacts/editor-tools/web-trace.json",
  },
  comparisons,
