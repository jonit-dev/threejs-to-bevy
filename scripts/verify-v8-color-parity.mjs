...
export async function verifyV8ColorParity(options = {}) {
  ...
  const colorArtifactDir = options.artifactDir ?? resolve(root, "artifacts/v8/color-parity");
  const lightingArtifactDir = options.lightingArtifactDir ?? resolve(root, "artifacts/v8/lighting-tone");
