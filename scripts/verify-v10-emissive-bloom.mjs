...
const artifactDir = resolve(root, "artifacts/v10/emissive-bloom");
...
const report = {
  artifacts: {
    ...
    nativeTrace: "artifacts/v10/emissive-bloom/native-trace.json",
    webTrace: "artifacts/v10/emissive-bloom/web-trace.json",
  },
  comparisons,
