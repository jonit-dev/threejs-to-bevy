...
test("v10 advanced physics verifier writes sequential frame comparison artifacts", async () => {
  ...
  const report = JSON.parse(await readFile("artifacts/v10/advanced-physics/verification-report.json", "utf8"));
  ...
  await stat("artifacts/v10/advanced-physics/contact-sheet.png");
  await stat("artifacts/v10/advanced-physics/frames/web-frame-01.png");
  await stat("artifacts/v10/advanced-physics/frames/native-frame-01.png");
});
