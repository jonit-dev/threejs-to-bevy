...
const artifactDir = resolve(root, "tools/verify/artifacts/native-ui-effects");
...
const report = {
  artifacts: {
    ...
    nativeTrace: "tools/verify/artifacts/native-ui-effects/native-trace.json",
    webTrace: "tools/verify/artifacts/native-ui-effects/web-trace.json",
  },
  comparisons,
