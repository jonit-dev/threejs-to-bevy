...
const artifactDir = resolve(root, "artifacts/v10/native-ui-images");
...
const report = {
  artifacts: {
    ...
    nativeTrace: "artifacts/v10/native-ui-images/native-trace.json",
    webTrace: "artifacts/v10/native-ui-images/web-trace.json",
  },
  comparisons,
