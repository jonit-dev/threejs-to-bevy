...
const artifactDir = resolve(root, "artifacts/v10/editor-property-editing");
...
const report = {
  artifacts: {
    ...
    nativeTrace: "artifacts/v10/editor-property-editing/native-trace.json",
    webTrace: "artifacts/v10/editor-property-editing/web-trace.json",
  },
  comparisons,
