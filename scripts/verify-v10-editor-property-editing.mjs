...
const artifactDir = resolve(root, "tools/verify/artifacts/editor-property-editing");
...
const report = {
  artifacts: {
    ...
    nativeTrace: "tools/verify/artifacts/editor-property-editing/native-trace.json",
    webTrace: "tools/verify/artifacts/editor-property-editing/web-trace.json",
  },
  comparisons,
